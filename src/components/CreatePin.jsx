        ...
        <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
          ...
          <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
            <input 
                ...
                className='outline-black text-2xl sm:text-3xl font-bold borer-b-2 border-gray-200 p-2'
            />
            {user && (
            ...
            className='outline-black text-base sm:text-lg borer-b-2 border-gray-200 p-2'
        />
        <input 
            type='text'
            value={destination}
            ...
            className='outline-gray text-base sm:text-lg borer-b-2 border-gray-200 p-2'
        />
